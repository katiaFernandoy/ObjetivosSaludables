...
public class MailJob extends AsyncTask<MailJob.Mail,Void,Void> {
    ...
    protected Void doInBackground(Mail... mails) {
        ...
        /*Log.d("Empezando exe","enviando mail");
        MailJob mailJob =new MailJob("diego.jimenezadm@gmail.com","srxidszyqxaeyhnt");
        mailJob.execute(new MailJob.Mail("diego.jimenezadm@gmail.com",
                "diego.jimenezadm@gmail.com","hola","alo"));*/
